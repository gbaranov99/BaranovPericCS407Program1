...
class BaranovPericStd(Peer):
    ...
    def requests(self, peers, history):
        ...
        #############################################################################
        # piece_order = sorted(frequencies, key=frequencies.get)
        ...
        res = set([k for k, v in frequencies.items() if v==minval])
        ...
        for peer in peers:
            ...
            isect = (av_set.intersection(np_set)).intersection(res)
            print('isect hehehe: ' + str(isect))

            # gud_array = []
            # for i in piece_order:
            #     if i in isect:
            #         gud_array.append(i)
            # print('gudarray: ' + str(gud_array))
            ...
            for piece_id in random.sample(isect, int(n)):
                print('piecarion: ' + str(piece_id))
            # for piece_id in gud_array:
                #print('testtest' + str(piece_id))
